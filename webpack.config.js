...
module.exports = {
    ...
    entry: {
        app: './src/app.js',
        'pdf.worker': 'pdfjs-dist/build/pdf.worker.entry.js' //tratando o PDF
    },

    //arquivo de saída: quando fizer a união de todos os arquivos que precisa, retorna em qual arquivo e qual é o caminho
    output = {
        filename: '[name].bundle.js', //concatena a chave de cima (pdf.worker), bundle é o compilado de arquivos js
