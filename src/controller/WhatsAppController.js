...
export class WhatsAppController{
        ...
        this._firebase.initAuth().then(response =>{
            ...
            this._user.on('datachange', data =>{ //ouve um evento, a mudança de dados
                ...
                if(data.photo){ //se tem foto
                    ...
                    this.el.imgDefaultPanelEditProfile.hide() //oculta a foto de sem-foto

                    let photo2 = this.el.myPhoto.querySelector('img') //foto do usuário logado na página principal
            ...
            this.el.appContent.css({ //quando logar, aparece a aplicação
                display: 'flex'
            })
    ...
    initContacts(){//busca os contatos do usuário autenticado
        ...
        this._user.on('contactschange', docs=>{
            ...
            docs.forEach(doc=>{ //para cada contato/documento
                ...
                //para cada contato, cria uma div diferente
                ...
                div.innerHTML = `<div class="dIyEr">
                                ...
                                `
                if(contact.photo){ //se nos dados de doc contém uma foto
    ...
    initEvents(){
        ...
        this.el.btnSendPicture.on('click', e=>{
            ...
            picture.onload = e=>{
                ...
                .then(file =>{
                    ...
                    this.el.painelMessagesContainer.show()
                })
            }            
        })
        //
        ...
        this.el.panelEmojis.querySelectorAll('.emojik').forEach(emoji =>{
            emoji.on('click', e=>{
                ...
                range = cursor.getRangeAt(0) //pega o começo da seleção
    ...
    setActiveChats(contact){
        ...
        if(contact.photo){
            ...
            this.el.home.hide()//oculta o painel de home
            this.el.main.css({ //mostra o painel de mensagens
                display: 'flex'
            }) 
        }
    ...
    loadElements(){
        ...
        document.querySelectorAll('[id]').forEach(element=>{
            this.el[Format.getCamelCase(element.id)] = element //coloca cada id em CamelCase
        })
    }
